...
from dataloader import MOIGENLoader
...
def parse_args():
    ...
    parser.add_argument("--task_name", default='MOIGEN', type=str, required=False)
    ...
    parser.add_argument("--save_path", default='./new_save/35.MOI-GEN/', type=str, required=False)
...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load('./new_save/35.MOI-GEN/best(959999).th')['model'])
    i=-1
        ...
        for batch in tqdm(train_loader):
            ...
            if i % args.eval_steps == args.eval_steps - 1:
                ...
                with torch.no_grad():
                    ...
                    torch.save({
                        'model': model.state_dict(),
                    }, f'./new_save/35.MOI-GEN/best({i}).th')
                model.train()
