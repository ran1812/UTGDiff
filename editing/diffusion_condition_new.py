...
class DiscreteDiffusionMatrixBase(DiscreteDiffusionBase):
    ...
    def sample_and_compute_posterior_q(self,
        ...
        if self.supports_efficient_get():
            ...
            prob_at_time_t_plus_one = self.get_qt_given_q0(q0=x_0, t=t + step_size, word_freq_logits=word_freq_logits, mask_id = mask_id, func_type=func_type)
...
class MaskDiffusion(DiscreteDiffusionMatrixBase):
    ...
    def noise_fn(self, q0, t, word_freq_logits, mask_id = None,func_type=None):
        p = self.state[t]
        if mask_id is None:
            mask_id = self.tokenizer.mask_token_id
    ...
    def get_qt_given_q0(self,
        ...
        prob_at_time_t = q0 if t == 0 else self.noise_fn(q0, t, word_freq_logits,mask_id = mask_id,func_type=func_type)
...
def discrete_diffusion_predict_fn(
  ...
  """
    ...
    def sampling_step(step, state):
        ...
        return SamplingState(x=sample, x0=x0, e=sample_edge, e0=true_edge, t=t - step_size)
