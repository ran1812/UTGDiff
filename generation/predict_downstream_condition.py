...
parser.add_argument("--ckpt_path", default='./new_save/25.simple_charge/best(1669999).th', type=str, required=False)
...
with torch.no_grad():
    for i, batch in enumerate(tqdm(test_loader)):
        ...
        with open(f'./generation_results/{task_name}_{args.topk}_MBR_(25_166_8).txt', 'a+') as f_mbr:
