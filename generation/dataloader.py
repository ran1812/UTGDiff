...
class fixedCHEBILoader(GraphLoader):
    def __init__(self, tokenizer, return_source_length=False):
        super(fixedCHEBILoader, self).__init__(tokenizer, return_source_length)
        self.task_name = 'fixed_CHEBI'
...
class PCDesLoader(GraphLoader):
    def __init__(self, tokenizer, return_source_length=False):
        super(PCDesLoader, self).__init__(tokenizer, return_source_length)
        self.task_name = 'PCDes'
