...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load('./new_save/38.addcorrupt2/best(219999).th', map_location=lambda storage, loc: storage.cuda(local_rank))['model'])
    i=-1
        ...
        for batch in tqdm(train_loader):
            ...
            if i % args.eval_steps == args.eval_steps - 1:
                ...
                with torch.no_grad():
                    ...
                    torch.save({
                        'model': model.state_dict(),
                    }, f'./new_save/38.addcorrupt2/best({i}).th')
                model.train()
